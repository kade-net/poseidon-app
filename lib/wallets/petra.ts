...
import { NoPrivateKey, NoPrivateKeyError, PetraConnectionRejected, UnableToDeserializePetraResponse, UnableToGeneratePetraSharedSecret, UnableToStorePetraSharedSecret } from '../../utils/errors'
...
class PetraWallet {
    ...
    async connect(current_location?: string) {
        ...
        const payload: PetraRequestedInfo = {
            ...
            redirectLink: `${Linking.createURL(current_location ?? "/settings/connect")}`,
